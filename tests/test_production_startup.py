...
def _register_and_get_cookie_flag(
    ...
    from tests.db_reset import TEST_DATABASE_URL, run_async, wipe_schema

    # this test runs the app in a subprocess - see reset_app_database()'s docstring on why
    # wipe_schema() is bridged through run_async() rather than awaited directly here.
