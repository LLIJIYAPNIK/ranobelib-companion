...
def test_get_settings_defaults(monkeypatch) -> None:
    ...
    assert (
        ...
        == "postgresql://postgres:postgres@localhost:5432/ranobelib_companion"
    )
...
def test_get_settings_reads_env(monkeypatch) -> None:
    ...
    monkeypatch.setenv("DATABASE_URL", "postgresql://user:pw@db-host:5432/ranobelib")
    ...
    assert settings.database_url == "postgresql://user:pw@db-host:5432/ranobelib"
